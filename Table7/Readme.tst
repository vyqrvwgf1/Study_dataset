This folder contains training and testing datasets for Table 7.
...
community: the number of users that appears in the pull request, issues, and committer mumbers.
