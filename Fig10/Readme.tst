KTDSM folder contains trainning and testing datasets that were selected by KTDSM.
RTDSM folder contains trainning and testing datasets that were selected by RTDSM.
