...
tf.flags.DEFINE_string("positive_data_file", config.test_pos_filename, "Data source for the positive data.")
tf.flags.DEFINE_string("negative_data_file", config.test_neg_filename, "Data source for the negative data.")
